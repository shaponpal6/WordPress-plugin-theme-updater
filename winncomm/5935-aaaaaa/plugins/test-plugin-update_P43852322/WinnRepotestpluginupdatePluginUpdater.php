<?php 
        class WinnRepotestpluginupdatePluginUpdater        {
            // Winnrepo server
            /**
             ...
             */
            public function __construct( $update_path,  $license_key, $plugin_slug )
            {
            // Set the class public variables
            $this->current_version = '';
            $this->update_path = $update_path.'plugin_updater_server/'.$license_key;
