...
<head>
    ...
    <title>WinnRepo | Admin Dashboad</title>
...
<body class="body-Login-back"
      style="background: url(<?php echo base_url('assets/img/login.jpg'); ?>) no-repeat center center fixed;
                ...
                <div class="login-panel panel panel-default">                  
                    <div class="panel-heading">
                        ...
                        <div style="float:right; font-size: 85%; position: relative; top:-10px">
                            <a href="<?php echo base_url('users/signup'); ?>">Registration</a>
                        </div>
                    </div>
                    <div class="panel-body">
                        <?php echo form_open('Users/login', ''); ?>
                            <fieldset>
                                ...
                                <input id="btn-login" name="loginSubmit" type="submit" class="btn btn-lg btn-success btn-block"
                                       value="Login" >
                            </fieldset>
                        </form>
                    </div>
