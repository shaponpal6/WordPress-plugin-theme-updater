    ...
    <div class="row">
        <div class="col-lg-12">
            ...
            <div class="panel panel-default">
                <div class="panel-heading">
                    <div class="tooltip-demo">
                        <button type="button" onclick="new_version_data(<?= $single_data->theme_id; ?>)"
                                class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModal_new_version">Add
                            New Version
                        </button>
                        <button type="button" onclick="add_more_feature(<?= $single_data->theme_id; ?>)"
                ...
                <?php //echo '<pre>'; // print_r($single_data);?>
                    ...
                    <div class="table-responsive">
                        <table class="table table-striped table-bordered table-hover" id="dataTables-example222">
                            ...
                            <tr class="odd gradeX">
                                ...
                                <td class="text-center"><?= $single_data->theme_file_name; ?></td>
                                ...
                                <td class="text-center"><?php if (!empty($single_data->theme_size)) {
                                        echo sprintf("%.2f", $single_data->theme_size / 1024);
                                    } ?> MB
                                </td>
                                ...
                                <td class="text-center" style="min-width: 204px;">
                                    ...
                                    <button onclick="new_version_data(<?= $single_data->theme_id; ?>)" type="button"
                                            class="btn btn-warning btn-sm" data-toggle="modal"
                                            data-target="#myModal_edit_version">Edit
                                    </button>
                                    <?= form_open('Themes/delete/' . $single_data->theme_id, 'onsubmit="return confirm(\'Are you sure you want to delete this Theme?\');" style="display:inline-block;"') . form_hidden('theme_id', $single_data->theme_id) . '<button type="submit"  class="btn btn-danger btn-sm">Delete</button>' . form_close(); ?>
                            ...
                            foreach ($ip as $ip): ?>
                                <tr class="odd gradeX">
                                    ...
                                    <td class="text-center">
                                        ...
                                        <?= form_open('themes/ip_blocker/' . $ip->status,
            ...
            <div class="version_crl_sec">
                <h2>Theme Code</h2>
                <p>To setup your Theme with WP Updates please follow these steps:</p>
                <ol>
                    <?php
                    $this->load->library('RepositoryHelper');
                    $repo = new RepositoryHelper();
                    $WinnRepo = 'WinnRepo' . $repo->slug_space($single_data->title) . 'ThemeUpdater';
                    $id = $single_data->theme_id; ?>

                    <li>
                        <div
                            class="tooltip-demo"><?= form_open('Downloader/theme_auto_update_class_download/' . $id . '/' . $WinnRepo) . form_hidden('theme_id', $id) . 'Download the <button type="submit" class="btn btn-outline btn-primary btn-xs" data-toggle="tooltip" data-placement="top" title="" data-original-title="Download file with Licences Key."> ' . $WinnRepo . ' class  </button> to your theme\'s root folder.' . form_close(); ?></div>
                    </li>
                    <li>Open up your theme's main file and insert the following code:
    ...
    function delete_version_data(id) {
        if (confirm('Are you sure you want to delete this thing into the database?')) {
            $.post("sp_check_before_delete_ok_jdhfj/" + id, {'id': id}, function (data) {
                window.location = '<?=site_url("themes/delete");?>';
            });
        } else {
            // Do nothing!
        }
...
<!-- Modal -->
<!--Add New version of themes<-->
<div class="modal fade" id="myModal_new_version" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open_multipart('themes/add_new_version', 'class="form-horizontal"'); ?>
            ...
            <div class="modal-body">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <p>Make sure the zip filename is the same as the Theme folder name (i.e. no version numbers)</p>
                    </div>
                </div>
                <div class="form-group">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-10">
                        ...
                        <p>The most recent version of WordPress the Theme is compatible with</p>
                    </div>
                </div>
...
<!--Add more feature of themes<-->
<div class="modal fade" id="add_more_feature" role="dialog">
    <div class="modal-dialog modal-md">
        <?php echo form_open_multipart('themes/add_more_feature', 'class="form-horizontal"'); ?>

        <div class="modal-content">
            <div class="modal-header panel-heading">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Add more info in Theme update page.</h4>
            </div>
            <div class="modal-body">
...
<!--                        <p>Banners size will be <b>772 x 250</b> to fit in Theme update page.</p>-->
<!--                    </div>-->
<!--                </div>-->
                <div class="form-group">
...
<div class="modal fade" id="myModal_edit_version" role="dialog">
    <div class="modal-dialog modal-md">
        ...
        <div class="modal-content">
            <div class="modal-header panel-heading">
                <button type="button" class="close" data-dismiss="modal">&times;</button>
                <h4 class="modal-title">Add New version of themes</h4>
            </div>
            <div class="modal-body">
