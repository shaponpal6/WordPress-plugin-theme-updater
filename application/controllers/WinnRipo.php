...
class WinnRipo extends CI_Controller
{
...
//        }
    ...
    public function plugin_updater_server()
    {
...
//                    $plugin->autoUpdateNow($data);
                   // print_r($plugin->autoUpdateNow($data));
                    $aaa = ['args'=> $data];

                    // Display I view Page
                    $this->load->view('update', $aaa);
...
//                    $plugin->autoUpdateNow($data);
    ...
    public function theme_updater_server()
    {
